...
\label{calib_1}
\begin{center}
\includegraphics[width=15cm]{images/calibration-1-settings.png}
...
\label{calib_2}
\begin{center}
\includegraphics[width=15cm]{images/calibration-2-mask.png}
...
\label{calib_3}
\begin{center}
\includegraphics[width=15cm]{images/calibration-3-peak-picking.png}
...
\label{calib_4}
\begin{center}
\includegraphics[width=15cm]{images/calibration-4-fitting.png}
\caption{Selection of the fit parameters and validation of the model.}
\end{center}
\end{figure}
\begin{figure}
\label{calib_5}
\begin{center}
\includegraphics[width=15cm]{images/calibration-5-integration-result.png}
