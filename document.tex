...
\begin{itemize}
  ...
  magnitude.
  \item $rot_3$ cannot be refined as Debye-Scherrer cones are invariant by
  rotation around the incoming beam.
\end{itemize}
...
This new graphical user interface is available as \textit{pyFAI-calib2}
command.
